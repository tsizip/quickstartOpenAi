...
export default function Home() {
     ...
     const [chatLog, setChatLog] = useState([
          ...
          { user: 'tsizip', message: 'Test' }
     ])

     const handleSubmit = async (e) => {
          e.preventDefault()
          // console.log('first')
          setChatLog([...chatLog, { user: 'tsizip', message: `${input}` }])
          setInput('')
     ...
     return (
          <div className='home'>
               <div className='row '>
                    ...
                    <div className='col-10 chatbox'>
                         <div className='chat-log mb-5'>
                         ...
                         <form onSubmit={handleSubmit} className='chat-input-holder'>
                              <input
                                   className='chat-input-textarea' placeholder='type here!'
                                   row='1'
                                   value={input}
                                   onChange={(e) => {
